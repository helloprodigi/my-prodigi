  ...
  return (
    <div className="w-full h-full min-h-[calc(100vh-4rem)] lg:min-h-screen bg-[#FAFAFA] flex flex-col items-center justify-center p-8">
      <div className="max-w-xl w-full bg-white p-12 rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
        ...
        <h1 className="text-3xl font-bold text-[#0A1024] mb-4">Notifikasi Coming Soon!</h1>
        
        <p className="text-gray-600 mb-8 leading-relaxed">
          Pusat pemberitahuan Anda saat ini sedang dalam <span className="font-semibold text-[#0A1024]">tahap development</span>. 
          Anda akan segera bisa menerima pembaruan langsung tentang status lomba dan undangan tim di sini.
        </p>
      </div>
    </div>
  );
