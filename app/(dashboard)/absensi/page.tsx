...
export default function AbsensiAdminPage() {
  ...
  return (
    <div className="p-6 md:p-10 w-full space-y-8">
      ...
      <div className="flex space-x-1 bg-gray-100 border border-gray-200 p-1.5 rounded-2xl w-fit ">
        <button
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <button 
                            ...
                            className="px-3.5 py-2 text-xs font-bold text-[#0B132B] bg-[#FFC727] hover:bg-[#e5b323] rounded-xl transition-all  flex items-center gap-1.5 shrink-0"
