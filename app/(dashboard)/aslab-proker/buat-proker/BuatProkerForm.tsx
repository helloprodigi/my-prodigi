...
export function BuatProkerForm({ allowedDivisions }: { allowedDivisions: AllowedDivision[] }) {
  const router = useRouter();
  const [divisi, setDivisi] = useState(allowedDivisions.length === 1 ? allowedDivisions[0].name : "");
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-[#F5F5F5] rounded-lg px-4 py-3 pr-10 text-sm text-[#0A1024] outline-none focus:ring-2 focus:ring-[#FFC700] appearance-none disabled:opacity-70"
                required
